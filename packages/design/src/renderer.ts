  ...
  switch (target) {
    ...
    default:
      return {
        ...
        warnings: [{
          kind: "stub",
          message: `target "${target}" is declared by spec but not yet emitted natively. shipping next in @kpanks/design.`,
...
function renderReactRemotion(scene: PraetorScene): RenderResult {
  ...
  const composition = `// Auto-generated by @kpanks/design — do not edit by hand.
...
`;
  ...
  const root = `// Auto-generated by @kpanks/design — do not edit by hand.
...
`;
  ...
  const indexEntry = `// Auto-generated by @kpanks/design — do not edit by hand.
import { registerRoot } from "remotion";
import { Root } from "./Root.js";
registerRoot(Root);
`;

  const remotionConfig = `// Auto-generated by @kpanks/design — do not edit by hand.
...
# Auto-generated by @kpanks/design — render this scene to mp4.
...
REM Auto-generated by @kpanks/design — render this scene to mp4 (Windows).
cd /d "%~dp0"
...
This bundle is emitted by @kpanks/design. Do not hand-edit the .tsx files —
they are derived from the PraetorScene at \`<scene>.json\`. To change the
output, change the scene + re-render via @kpanks/design.
`;
...
Auto-generated from a PraetorScene by \`@kpanks/design\`. Drop this folder
...
hand-edit, regenerate via \`@kpanks/design\`'s \`render(scene, "claude-skill")\`.
...
\`\`\`ts
import { tokens } from "@kpanks/design";
...
\`tokens.ts\` in \`@kpanks/design\` and re-render this skill.
